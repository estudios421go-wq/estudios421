...
const InicioPC = () => {
  ...
  const banners = [
    ...
    { id: 2, path: "/serie/reyes-la-emboscada", trailer: "https://ok.ru/videoembed/15751107119616", bg: "https://static.wixstatic.com/media/859174_9343d48d63e648a58f8389da18e1a645~mv2.jpg", logo: "https://static.wixstatic.com/media/859174_373d72b97d7e49c6a2ed99da442b8e5a~mv2.png", desc: "El conflicto se intensifica y el reino enfrenta amenazas ocultas. Conspiraciones, alianzas y traiciones marcan el destino de Israel. Mientras el poder se disputa en las sombras, una emboscada cambiará el curso de la historia." },
