...
const InicioPC = () => {
  ...
  const NextArrow = ({ onClick }: any) => (
    <div className="absolute right-0 top-0 bottom-0 z-50 flex items-center justify-center w-12 hover:bg-[#F09800] cursor-pointer transition-all duration-300 group" onClick={onClick}>
      <IoChevronForward className="text-white group-hover:scale-125" size={45} />
    </div>
  );

  const PrevArrow = ({ onClick }: any) => (
    <div className="absolute left-0 top-0 bottom-0 z-50 flex items-center justify-center w-12 hover:bg-[#F09800] cursor-pointer transition-all duration-300 group" onClick={onClick}>
      <IoChevronBack className="text-white group-hover:scale-125" size={45} />
    </div>
  );
  ...
  const MovieRow = ({ title, movies }: any) => {
    ...
    return (
      <div className="mb-14 px-4 md:px-16 relative group/row overflow-hidden">
        ...
        <div className="relative carrusel-container">
  ...
  const banners = [
    ...
    { id: 4, path: "/serie/la-vida-de-job", trailer: "https://ok.ru/videoembed/14703420508672", bg: "https://static.wixstatic.com/media/859174_b9159dfbf8cc403eb180531c8338589e~mv2.jpg", logo: "https://static.wixstatic.com/media/859174_57a3f59e3dc44abc96ad1508f1ecf6db~mv2.png", desc: "La fe de un hombre justo es llevada al límite..." },
    { id: 5, path: "/serie-tv/la-casa-de-david", trailer: "https://ok.ru/videoembed/14703421032960", bg: "https://static.wixstatic.com/media/859174_25f3802c3bc0432b85c91bed4f588599~mv2.jpg", logo: "https://static.wixstatic.com/media/859174_483e446bb507429694def615b148509d~mv2.png", desc: "De pastor de ovejas al trono de Israel..." },
    { id: 6, path: "/serie/el-senor-y-la-sierva", trailer: "https://ok.ru/videoembed/14703422867968", bg: "https://static.wixstatic.com/media/859174_d16e8080cf4043e5a7b17a2538f8dcf5~mv2.jpg", logo: "https://static.wixstatic.com/media/859174_4f27eb2a8b7741f69eccead2e7fd0dcf~mv2.png", desc: "En el Imperio romano, surge un amor imposible..." }
  ];
              ...
              <div key={item.id} className="relative w-full h-[95vh] outline-none">
                ...
                <div className="absolute inset-0 z-20 flex flex-col justify-center px-20 pt-10">
                  ...
                  <div className="flex items-center gap-5">
                    <button onClick={() => router.push(item.path)} style={{ backgroundColor: '#F09800' }} className="text-white px-9 py-3 rounded-md font-bold flex items-center gap-2 hover:scale-105 transition-all"><FaPlay size={12} /> Ver Ahora</button>
                    ...
                    <a href="https://www.paypal.com/donate/?hosted_button_id=C2Y74BGQB4HKS" target="_blank" rel="noreferrer" className="bg-black/40 text-white px-6 py-3 rounded-md font-bold border border-[#F09800]/50 hover:scale-105 transition-all flex items-center gap-2"><BiDonateHeart size={20} className="text-[#F09800]" /> Donar</a>
                  </div>
                </div>
              </div>
            ))}
      ...
      <footer className="bg-[#0a0a0a] text-gray-400 py-12 px-8 md:px-16 border-t border-white/5">
        <div className="max-w-7xl mx-auto text-xs">
          <div className="flex justify-center md:justify-end gap-6 mb-10">
            <a href="https://youtube.com/@estudios421max" target="_blank" className="hover:text-white transition-colors text-xl"><FaYoutube /></a>
            <a href="https://www.tiktok.com/@estudios421_com" target="_blank" className="hover:text-white transition-colors text-xl"><FaTiktok /></a>
          </div>
          <p>© {new Date().getFullYear()} Estudios 421. Todos los derechos reservados.</p>
          <p className="text-gray-500 mt-4 leading-relaxed">Aviso Legal: El contenido audiovisual compartido en este sitio pertenece a sus respectivos propietarios...</p>
        </div>
      </footer>

      {/* MODAL DE TRAILER CON BOTÓN VER AHORA AJUSTADO */}
      {showModal && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center px-4">
          ...
          <div className="relative w-full max-w-5xl aspect-video bg-[#0a0a0a] rounded-2xl overflow-hidden shadow-[0_0_60px_rgba(255,138,0,0.3)] border border-white/10">
            ...
            {/* BOTÓN VER AHORA ELEGANTE EN ESQUINA INFERIOR IZQUIERDA */}
