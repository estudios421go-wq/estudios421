...
const LaVidaPublicaDeJesusMobile = () => (
  <div className="bg-black min-h-screen text-white font-sans flex flex-col text-center">
    <Head><title>La vida pública de Jesús — Móvil</title></Head>
    <div className="flex-grow flex flex-col items-center justify-center px-8 relative">
      ...
      <h1 className="text-3xl font-black uppercase tracking-widest mb-4 leading-tight">La vida pública de Jesús</h1>
      <p className="text-[#FF8A00] text-[10px] font-bold tracking-widest uppercase mb-6 animate-pulse">Próximamente</p>
      <p className="text-gray-500 text-xs leading-relaxed mb-10 text-center">El relato más fiel de la vida de Jesús, muy pronto disponible en tus dispositivos.</p>
