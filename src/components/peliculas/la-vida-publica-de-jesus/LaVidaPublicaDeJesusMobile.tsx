...
// --- CONFIGURACIÓN DE LA PELÍCULA (ID: 63) ---
const MOVIE_DATA = {
  id: 63,
  title: "La Vida Pública De Jesús",
  titleEn: "The Public Life of Jesus",
  titlePt: "A Vida Pública de Jesus",
  url: "https://drive.google.com/file/d/1DRjKDW-P_xlUKUenWSdUZJVBD8m-0Mxp/preview",
  banner: "https://static.wixstatic.com/media/859174_b93a0610f2374ae39128b04dfc95f6c2~mv2.jpg"
};

const LaVidaPublicaDeJesusMobile = () => {
  ...
  useEffect(() => {
    if (searchQuery.trim().length >= 2) {
      ...
      const themeMap: { [key: string]: string[] } = {
        ...
        jesus: ['jesus', 'milagros', 'pasion', 'nazaret', 'cristo', 'vida publica'],
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6">
            <Link href="/pelicula/la-vida-publica-de-jesus" className="flex flex-col items-center gap-2"><img src="https://static.wixstatic.com/media/859174_367960b11c1c44ba89cd1582fd1b5776~mv2.png" className="w-10 h-10 object-contain" /><span className="text-[10px] font-bold">ESP</span></Link>
            <Link href="/en/movie/the-public-life-of-jesus" className="flex flex-col items-center gap-2"><img src="https://static.wixstatic.com/media/859174_35112d9ffe234d6f9dcef16cf8f7544e~mv2.png" className="w-10 h-10 object-contain" /><span className="text-[10px] font-bold">ENG</span></Link>
            <Link href="/pt/filme/a-vida-publica-de-jesus" className="flex flex-col items-center gap-2"><img src="https://static.wixstatic.com/media/859174_830f1c20656e4d44a819bedfc13a22cc~mv2.png" className="w-10 h-10 object-contain" /><span className="text-[10px] font-bold">PT</span></Link>
          </div>
        </div>
      </div>
...
export default LaVidaPublicaDeJesusMobile;
