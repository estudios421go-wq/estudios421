...
// --- CONFIGURACIÓN DE LA PELÍCULA (ID: 61) ---
const MOVIE_DATA = {
  id: 61,
  title: "Ben Hur 1959",
  titleEn: "Ben Hur 1959",
  titlePt: "Ben Hur 1959",
  url: "https://drive.google.com/file/d/13qH7Kb3voDu2RxSdh9GoBqFiS1W5Zd2A/preview",
  banner: "https://static.wixstatic.com/media/859174_d8add88905d441d2a53088300eb5047b~mv2.jpg"
};
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6">
            <Link href="/pelicula/ben-hur-1959" className="flex flex-col items-center gap-2"><img src="https://static.wixstatic.com/media/859174_367960b11c1c44ba89cd1582fd1b5776~mv2.png" className="w-10 h-10 object-contain" /><span className="text-[10px] font-bold">ESP</span></Link>
            <Link href="/en/movie/ben-hur-1959" className="flex flex-col items-center gap-2"><img src="https://static.wixstatic.com/media/859174_35112d9ffe234d6f9dcef16cf8f7544e~mv2.png" className="w-10 h-10 object-contain" /><span className="text-[10px] font-bold">ENG</span></Link>
            <Link href="/pt/filme/ben-hur-1959" className="flex flex-col items-center gap-2"><img src="https://static.wixstatic.com/media/859174_830f1c20656e4d44a819bedfc13a22cc~mv2.png" className="w-10 h-10 object-contain" /><span className="text-[10px] font-bold">PT</span></Link>
          </div>
        </div>
      </div>
