...
const BenHur1959PC = () => {
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans select-none flex flex-col">
      <Head><title>Ben-Hur (1959) — Estudios 421</title></Head>
      <div className="flex-grow flex flex-col items-center justify-center relative px-4">
        ...
        <div className="z-10 text-center space-y-8 max-w-2xl">
          ...
          <p className="text-[#FF8A00] text-sm font-bold tracking-[0.4em] uppercase">Edición Clásica 1959</p>
          <p className="text-gray-400 text-base leading-relaxed">Próximamente disponible. Estamos restaurando esta épica cinematográfica para ofrecerte la mejor experiencia visual.</p>
          <Link href="/">
