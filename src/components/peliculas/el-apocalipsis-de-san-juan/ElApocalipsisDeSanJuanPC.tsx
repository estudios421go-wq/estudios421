...
const ElApocalipsisDeSanJuanPC = () => {
  useEffect(() => {
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans select-none flex flex-col">
      <Head><title>El Apocalipsis de San Juan — Estudios 421</title></Head>
      <div className="flex-grow flex flex-col items-center justify-center relative px-4 text-left">
        ...
        <div className="z-10 text-center space-y-8 max-w-2xl">
          ...
          <h1 className="text-5xl font-black uppercase tracking-[0.2em]">El Apocalipsis</h1>
          <p className="text-[#FF8A00] text-sm font-bold tracking-[0.4em] uppercase">de San Juan</p>
          <p className="text-gray-400 text-base leading-relaxed">Estamos reconstruyendo esta experiencia visual para ofrecerte la mejor calidad cinematográfica de esta profecía bíblica.</p>
          <Link href="/">
...
export default ElApocalipsisDeSanJuanPC;
