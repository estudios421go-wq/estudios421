...
const ApocalipsisSanJuanMobile = () => {
  ...
  useEffect(() => {
    if (searchQuery.trim().length >= 2) {
      ...
      const themeMap: { [key: string]: string[] } = {
        ...
        apocalipsis: ['apocalipsis', 'juan', 'revelacion', 'profecia', 'fin del mundo'],
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6">
            <Link href="/pelicula/el-apocalipsis-de-san-juan" className="flex flex-col items-center gap-2"><img src="https://static.wixstatic.com/media/859174_367960b11c1c44ba89cd1582fd1b5776~mv2.png" className="w-10 h-10 object-contain" /><span className="text-[10px] font-bold">ESP</span></Link>
            <Link href="/en/movie/the-revelation-of-saint-john" className="flex flex-col items-center gap-2"><img src="https://static.wixstatic.com/media/859174_35112d9ffe234d6f9dcef16cf8f7544e~mv2.png" className="w-10 h-10 object-contain" /><span className="text-[10px] font-bold">ENG</span></Link>
            <Link href="/pt/filme/el-apocalipse-de-sao-joao" className="flex flex-col items-center gap-2"><img src="https://static.wixstatic.com/media/859174_830f1c20656e4d44a819bedfc13a22cc~mv2.png" className="w-10 h-10 object-contain" /><span className="text-[10px] font-bold">PT</span></Link>
          </div>
        </div>
      </div>
...
export default ApocalipsisSanJuanMobile;
