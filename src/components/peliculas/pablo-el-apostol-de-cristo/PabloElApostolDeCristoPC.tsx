...
const PabloElApostolDeCristoPC = () => {
  useEffect(() => {
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans select-none flex flex-col">
      <Head><title>Pablo, el apóstol de Cristo — Estudios 421</title></Head>
      <div className="flex-grow flex flex-col items-center justify-center relative px-4">
        ...
        <div className="z-10 text-center space-y-8 max-w-2xl">
          ...
          <h1 className="text-6xl font-black uppercase tracking-[0.2em]">Pablo</h1>
          <p className="text-[#FF8A00] text-sm font-bold tracking-[0.4em] uppercase text-center">El apóstol de Cristo</p>
          <p className="text-gray-400 text-base leading-relaxed">Próximamente disponible. Estamos preparando esta inspiradora historia con la mejor fidelidad visual y sonora.</p>
          <Link href="/">
...
export default PabloElApostolDeCristoPC;
