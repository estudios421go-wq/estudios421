...
const LaHistoriaDeLaReinaEsterMobile = () => (
  <div className="bg-black min-h-screen text-white font-sans flex flex-col text-center">
    <Head><title>La historia de la reina Ester — Móvil</title></Head>
    <div className="flex-grow flex flex-col items-center justify-center px-8 relative">
      <div className="w-16 h-1 bg-[#FF8A00] mb-6" />
      <h1 className="text-3xl font-black uppercase tracking-widest mb-4 leading-tight text-center">La historia de la reina Ester</h1>
...
export default LaHistoriaDeLaReinaEsterMobile;
