...
const MoisesYLosDiezMandamientosMobile = () => (
  <div className="bg-black min-h-screen text-white font-sans flex flex-col text-center">
    ...
    <div className="flex-grow flex flex-col items-center justify-center px-8 relative">
      ...
      <p className="text-gray-500 text-xs leading-relaxed mb-10">Próximamente disponible con la mejor calidad. Gracias por tu paciencia.</p>
...
export default MoisesYLosDiezMandamientosMobile;
