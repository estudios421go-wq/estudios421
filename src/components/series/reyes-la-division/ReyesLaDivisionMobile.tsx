...
const reyesDivisionEpisodes = [
  ...
  { id: 8, title: "ESTRENO 11 DE MARZO", dur: "53:53", thumb: "https://static.wixstatic.com/media/859174_03b83bd91ff949b79697902a856cb303~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 9, title: "ESTRENO 12 DE MARZO", dur: "46:26", thumb: "https://static.wixstatic.com/media/859174_708e23d17b4a42c7b40643e95a652406~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 10, title: "ESTRENO 13 DE MARZO", dur: "38:35", thumb: "https://static.wixstatic.com/media/859174_6097d9e18b6146608c20aba4e04e4060~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 11, title: "ESTRENO 16 DE MARZO", dur: "41:32", thumb: "https://static.wixstatic.com/media/859174_ef4eb8ef50244e8a955296e4c54155cf~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 12, title: "ESTRENO 17 DE MARZO", dur: "47:10", thumb: "https://static.wixstatic.com/media/859174_a4cc78e48cd244bca26e16625e112fcc~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 13, title: "ESTRENO 18 DE MARZO", dur: "49:36", thumb: "https://static.wixstatic.com/media/859174_d55d949485ab4ab6b1a1043c4a0d904d~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 14, title: "ESTRENO 19 DE MARZO", dur: "46:33", thumb: "https://static.wixstatic.com/media/859174_a0cf01916d504c709520ee0f7ce610f5~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 15, title: "ESTRENO 20 DE MARZO", dur: "44:20", thumb: "https://static.wixstatic.com/media/859174_f708519ca27947b28d89a438b2ae336f~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 16, title: "ESTRENO 23 DE MARZO", dur: "42:56", thumb: "https://static.wixstatic.com/media/859174_0e33347809ac404b9cead95e01c8ec85~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 17, title: "ESTRENO 24 DE MARZO", dur: "42:46", thumb: "https://static.wixstatic.com/media/859174_2ab275e32dc3421b91e3e298178c11e4~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 18, title: "ESTRENO 25 DE MARZO", dur: "38:18", thumb: "https://static.wixstatic.com/media/859174_26537bde4bb04ae4a99f954c30ad3979~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
  { id: 19, title: "ESTRENO 26 DE MARZO", dur: "38:38", thumb: "https://static.wixstatic.com/media/859174_286593b61f58427dac87a3b7e0162b3d~mv2.jpg", url: "https://ok.ru/videoembed/15391903456768", available: true },
];
...
const ReyesDivisionMobile = () => {
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem('reyes_division_mobile_last_ep');
    if (saved) {
        const idx = parseInt(saved);
        if (reyesDivisionEpisodes[idx]?.available) setCurrentIdx(idx);
    }
  ...
  const openEpisode = (idx: number) => {
    ...
    setCurrentIdx(idx);
    localStorage.setItem('reyes_division_mobile_last_ep', idx.toString());
  };
  ...
  if (selectedVideo) {
    return (
      <div className="fixed inset-0 z-[2000] bg-[#050608] flex flex-col overflow-hidden text-left">
        <Head><title>Reproduciendo: {reyesDivisionEpisodes[currentIdx].title}</title></Head>
        <div className="px-6 h-[85px] flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent border-b border-white/5 z-10">
          <div className="flex flex-col border-l-4 border-[#F09800] pl-4 py-1">
            <span className="text-[9px] font-black text-[#F09800] uppercase tracking-[0.3em] mb-1">Reyes: La División</span>
            <h2 className="text-sm font-black tracking-tight uppercase truncate max-w-[200px]">Ep. {reyesDivisionEpisodes[currentIdx].id} | {reyesDivisionEpisodes[currentIdx].title}</h2>
          </div>
        ...
        <div className="flex-grow flex flex-col relative bg-black items-center justify-center">
          ...
          <div className="absolute inset-x-0 bottom-8 flex justify-around items-center px-6">
            ...
            <button disabled={currentIdx === reyesDivisionEpisodes.length - 1 || !reyesDivisionEpisodes[currentIdx+1].available} onClick={() => openEpisode(currentIdx + 1)} className="flex flex-col items-center gap-2 group disabled:opacity-5">
      ...
      <div className="relative w-full pt-0 bg-black shadow-2xl">
        ...
        <div className="px-4 -mt-14 flex flex-col gap-3 relative z-20">
          <button onClick={() => openEpisode(currentIdx)} className="w-full bg-white text-black font-black py-4 rounded-md text-sm active:scale-95 transition-transform uppercase tracking-[0.2em] shadow-2xl">
            {currentIdx === 0 ? "▶ Ver Ahora" : `▶ Continuar Ep. ${reyesDivisionEpisodes[currentIdx].id}`}
          </button>
          ...
          {reyesDivisionEpisodes.map((ep, index) => (
            <div key={ep.id} className={`flex flex-col gap-2.5 transition-all ${ep.available ? 'active:scale-95' : 'opacity-40'}`} onClick={() => ep.available && openEpisode(index)}>
              ...
              <h3 className={`font-bold text-[10px] truncate uppercase tracking-tight ${ep.available ? 'text-white/90' : 'text-gray-500'}`}>
                EP. {ep.id} {ep.available ? ep.title : ep.title}
              </h3>
            </div>
          ))}
        </div>
