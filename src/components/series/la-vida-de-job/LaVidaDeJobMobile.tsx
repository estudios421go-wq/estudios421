...
// BASE DE DATOS EXTRAÍDA DE TU VERSIÓN PC
const jobEpisodes = [
...
const LaVidaDeJobMobile = () => {
  ...
  useEffect(() => {
    ...
    if (list.includes('vida-de-job')) setInMyList(true);
  ...
  const toggleMyList = () => {
    ...
    if (inMyList) { list = list.filter((id: string) => id !== 'vida-de-job'); setInMyList(false); } 
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans selection:bg-[#F09800] text-left">
      <Head><title>La vida de Job — Móvil</title></Head>
      ...
      <div className={`fixed inset-0 bg-black/98 z-[90] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8">
          ...
          <div className="flex gap-6">
            {[{l:'ESP', i:'367960b11c1c44ba89cd1582fd1b5776', r:'/serie/la-vida-de-job'}, 
              {l:'ENG', i:'35112d9ffe234d6f9dcef16cf8f7544e', r:'/en/serie/la-vida-de-job'}, 
              {l:'PT', i:'830f1c20656e4d44a819bedfc13a22cc', r:'/pt/serie/la-vida-de-job'}].map((lang) => (
