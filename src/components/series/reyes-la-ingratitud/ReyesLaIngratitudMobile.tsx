...
// --- CONFIGURACIÓN DE EPISODIOS (ID: 21) ---
const reyesIngratitudEpisodes = [
  "https://ok.ru/videoembed/9827204729527", "https://ok.ru/videoembed/9827205057207", "https://ok.ru/videoembed/9827205122743",
  "https://ok.ru/videoembed/9827205253815", "https://ok.ru/videoembed/9827205319351", "https://ok.ru/videoembed/9827205581495",
  "https://ok.ru/videoembed/9827205778103", "https://ok.ru/videoembed/9827205974711", "https://ok.ru/videoembed/9827206040247",
  "https://ok.ru/videoembed/9827206105783", "https://ok.ru/videoembed/9827884731063", "https://ok.ru/videoembed/9827884862135",
  "https://ok.ru/videoembed/9827889318583", "https://ok.ru/videoembed/9827889777335", "https://ok.ru/videoembed/9827889908407",
  "https://ok.ru/videoembed/9827890170551", "https://ok.ru/videoembed/9827890367159", "https://ok.ru/videoembed/9827890629303",
  "https://ok.ru/videoembed/9827891022519", "https://ok.ru/videoembed/9828010494647", "https://ok.ru/videoembed/9828010560183",
  "https://ok.ru/videoembed/9828986587831", "https://ok.ru/videoembed/9828986718903", "https://ok.ru/videoembed/9828986981047",
  "https://ok.ru/videoembed/9828987177655", "https://ok.ru/videoembed/9828987570871", "https://ok.ru/videoembed/9828987701943",
  "https://ok.ru/videoembed/9828987833015", "https://ok.ru/videoembed/9828987898551", "https://ok.ru/videoembed/9828988029623"
];

const ReyesIngratitudMobile = () => {
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem('reyes_ingratitud_mobile_last_ep');
  ...
  useEffect(() => {
    if (searchQuery.trim().length >= 2) {
      ...
      const themeMap: { [key: string]: string[] } = {
        ...
        reyes: ['reyes', 'david', 'saul', 'salomon', 'decepcion', 'ingratitud'],
  ...
  const openEpisode = (idx: number) => {
    setSelectedVideo(reyesIngratitudEpisodes[idx]);
    setCurrentIdx(idx);
    localStorage.setItem('reyes_ingratitud_mobile_last_ep', idx.toString());
  };
  ...
  if (selectedVideo) {
    return (
      <div className="fixed inset-0 z-[2000] bg-[#050608] flex flex-col overflow-hidden text-left">
        <Head><title>Episodio {currentIdx + 1} — Reyes: La Ingratitud</title></Head>
        <div className="px-6 h-[85px] flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent border-b border-white/5 z-10">
          <div className="flex flex-col border-l-4 border-[#F09800] pl-4 py-1">
            <span className="text-[9px] font-black text-[#F09800] uppercase tracking-[0.3em] mb-1">Reyes: La Ingratitud</span>
        ...
        <div className="flex-grow flex flex-col relative bg-black items-center justify-center">
          ...
          <div className="absolute inset-x-0 bottom-8 flex justify-around items-center px-6">
            ...
            <button disabled={currentIdx === reyesIngratitudEpisodes.length - 1} onClick={() => openEpisode(currentIdx + 1)} className="flex flex-col items-center gap-2 group disabled:opacity-5">
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans selection:bg-[#F09800] text-left">
      <Head><title>Reyes: La Ingratitud — Estudios 421</title></Head>
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6 text-center">
            {[{l:'ESP', i:'367960b11c1c44ba89cd1582fd1b5776', p:'/serie/reyes-la-ingratitud'}, {l:'ENG', i:'35112d9ffe234d6f9dcef16cf8f7544e', p:'/en/serie/reyes-la-ingratitud'}, {l:'PT', i:'830f1c20656e4d44a819bedfc13a22cc', p:'/pt/serie/reyes-la-ingratitud'}].map((lang) => (
      ...
      <div className="relative w-full pt-0 bg-black shadow-2xl">
        <div className="w-full aspect-[4/3] relative">
          <img src="https://static.wixstatic.com/media/859174_af83f39762954a149f18f003c00b74f7~mv2.jpg" className="w-full h-full object-contain" alt="Banner" />
      ...
      <div className="px-5 mt-12 mb-10 text-left">
        ...
        <div className="grid grid-cols-5 gap-3">
          {reyesIngratitudEpisodes.map((_, i) => (
      ...
      <div className="px-5 mb-24 text-center">
          <Link href="/serie/reyes-el-rechazo">
      ...
      <footer className="bg-[#0a0a0a] text-gray-500 py-10 px-6 border-t border-white/5 text-left">
        <div className="flex justify-start gap-6 mb-8 text-xl text-center">
...
export default ReyesIngratitudMobile;
