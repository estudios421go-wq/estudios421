...
// --- CONFIGURACIÓN DE EPISODIOS (ID: 7) ---
const sansonEpisodes = [
  "https://ok.ru/videoembed/7308902664800", "https://ok.ru/videoembed/7309011061344", "https://ok.ru/videoembed/7310581566048",
  "https://ok.ru/videoembed/7310665058912", "https://ok.ru/videoembed/7310670170720", "https://ok.ru/videoembed/7310692190816",
  "https://ok.ru/videoembed/7310717028960", "https://ok.ru/videoembed/7310742653536", "https://ok.ru/videoembed/7310743046752",
  "https://ok.ru/videoembed/7310743702112", "https://ok.ru/videoembed/7310743964256", "https://ok.ru/videoembed/7310744226400",
  "https://ok.ru/videoembed/7310747961952", "https://ok.ru/videoembed/7310930807392", "https://ok.ru/videoembed/7310931397216",
  "https://ok.ru/videoembed/7310931855968", "https://ok.ru/videoembed/7310931987040", "https://ok.ru/videoembed/7310932183648"
];
...
const SansonMobile = () => {
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem('sanson_mobile_last_ep');
  ...
  const openEpisode = (idx: number) => {
    setSelectedVideo(sansonEpisodes[idx]);
    setCurrentIdx(idx);
    localStorage.setItem('sanson_mobile_last_ep', idx.toString());
  };
  ...
  if (selectedVideo) {
    return (
      <div className="fixed inset-0 z-[2000] bg-[#050608] flex flex-col overflow-hidden text-left">
        <Head><title>Episodio {currentIdx + 1} — Sansón y Dalila</title></Head>
        <div className="px-6 h-[85px] flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent border-b border-white/5 z-10">
          <div className="flex flex-col border-l-4 border-[#F09800] pl-4 py-1">
            <span className="text-[9px] font-black text-[#F09800] uppercase tracking-[0.3em] mb-1">Sansón y Dalila</span>
        ...
        <div className="flex-grow flex flex-col relative bg-black items-center justify-center">
          ...
          <div className="absolute inset-x-0 bottom-8 flex justify-around items-center px-6">
            ...
            <button disabled={currentIdx === sansonEpisodes.length - 1} onClick={() => openEpisode(currentIdx + 1)} className="flex flex-col items-center gap-2 group disabled:opacity-5">
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans selection:bg-[#F09800] text-left">
      <Head><title>Sansón y Dalila — Estudios 421</title></Head>
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6">
            {[{l:'ESP', i:'367960b11c1c44ba89cd1582fd1b5776', p:'/serie/sanson-y-dalila'}, {l:'ENG', i:'35112d9ffe234d6f9dcef16cf8f7544e', p:'/en/serie/sanson-y-dalila'}, {l:'PT', i:'830f1c20656e4d44a819bedfc13a22cc', p:'/pt/serie/sanson-y-dalila'}].map((lang) => (
      ...
      <div className="relative w-full pt-0 bg-black shadow-2xl">
        <div className="w-full aspect-[4/3] relative">
          <img src="https://static.wixstatic.com/media/859174_9854e395dfa9413ba9dde15c6f44804f~mv2.jpg" className="w-full h-full object-contain" alt="Banner Sansón y Dalila" />
