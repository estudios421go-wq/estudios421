  "https://ok.ru/videoembed/3226301041248", "https://ok.ru/videoembed/3239180962400", "https://ok.ru/videoembed/3239181093472",
  "https://ok.ru/videoembed/3239187712608", "https://ok.ru/videoembed/3244408244832", "https://ok.ru/videoembed/3244450515552",
  "https://ok.ru/videoembed/3244450908768", "https://ok.ru/videoembed/3244408506976", "https://ok.ru/videoembed/3244408572512",
  "https://ok.ru/videoembed/3244408638048", "https://ok.ru/videoembed/3250810063456", "https://ok.ru/videoembed/3253103168096",
  "https://ok.ru/videoembed/3253103299168", "https://ok.ru/videoembed/3253103364704", "https://ok.ru/videoembed/3253103430240",
  "https://ok.ru/videoembed/3260904508000", "https://ok.ru/videoembed/3262987635296", "https://ok.ru/videoembed/3265311672928",
  "https://ok.ru/videoembed/3270870370912", "https://ok.ru/videoembed/3270870436448", "https://ok.ru/videoembed/3285302381152",
  "https://ok.ru/videoembed/3285302446688", "https://ok.ru/videoembed/3285302577760", "https://ok.ru/videoembed/3286792014432"
];
...
const JezabelMobile = () => {
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem('jezabel_mobile_last_ep');
  ...
  useEffect(() => {
    if (searchQuery.trim().length >= 2) {
      ...
      const themeMap: { [key: string]: string[] } = {
        ...
        jezabel: ['jezabel', 'acab', 'elias', 'israel', 'profetas'],
  ...
  const openEpisode = (idx: number) => {
    setSelectedVideo(jezabelEpisodes[idx]);
    setCurrentIdx(idx);
    localStorage.setItem('jezabel_mobile_last_ep', idx.toString());
  };
  ...
  if (selectedVideo) {
    return (
      <div className="fixed inset-0 z-[2000] bg-[#050608] flex flex-col overflow-hidden text-left">
        <Head><title>Episodio {currentIdx + 1} — Jezabel</title></Head>
        <div className="px-6 h-[85px] flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent border-b border-white/5 z-10">
          <div className="flex flex-col border-l-4 border-[#F09800] pl-4 py-1">
            <span className="text-[9px] font-black text-[#F09800] uppercase tracking-[0.3em] mb-1">Jezabel</span>
        ...
        <div className="flex-grow flex flex-col relative bg-black items-center justify-center">
          ...
          <div className="absolute inset-x-0 bottom-8 flex justify-around items-center px-6">
            ...
            <button disabled={currentIdx === jezabelEpisodes.length - 1} onClick={() => openEpisode(currentIdx + 1)} className="flex flex-col items-center gap-2 group disabled:opacity-5">
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans selection:bg-[#F09800] text-left">
      <Head><title>Jezabel — Estudios 421</title></Head>
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6">
            {[{l:'ESP', i:'367960b11c1c44ba89cd1582fd1b5776', p:'/serie/jezabel'}, {l:'ENG', i:'35112d9ffe234d6f9dcef16cf8f7544e', p:'/en/serie/jezabel'}, {l:'PT', i:'830f1c20656e4d44a819bedfc13a22cc', p:'/pt/serie/jezabel'}].map((lang) => (
      ...
      <div className="relative w-full pt-0 bg-black shadow-2xl">
        <div className="w-full aspect-[4/3] relative">
          <img src="https://static.wixstatic.com/media/859174_4ad1eec9b336453ea4c662643afd2948~mv2.jpg" className="w-full h-full object-contain" alt="Banner Jezabel" />
        ...
        <div className="px-4 -mt-14 flex flex-col gap-3 relative z-20">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => window.open('https://www.paypal.com/donate/?hosted_button_id=C2Y74BGQB4HKS', '_blank')} className="flex-1 bg-white/5 backdrop-blur-md py-3.5 rounded-md text-[10px] font-black border border-white/10 text-white active:bg-white/20">❤ Donar</button>
          </div>
        </div>
      </div>

      {/* SECCIÓN DE EPISODIOS (GRILLA NUMÉRICA MÓVIL) */}
      <div className="px-5 mt-12 mb-20 text-left">
        ...
        <div className="grid grid-cols-5 gap-3">
          {jezabelEpisodes.map((_, i) => (
            <button key={i} onClick={() => openEpisode(i)} className={`aspect-square rounded-md text-[10px] font-black border transition-all ${currentIdx === i ? 'bg-[#F09800] border-[#F09800] text-black' : 'bg-white/5 border-white/10 text-white/60 active:bg-white/10'}`}>
              {i + 1}
            </button>
          ))}
        </div>
