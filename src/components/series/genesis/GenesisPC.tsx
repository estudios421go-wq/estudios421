...
const genesisEpisodes = [
  ...
  { id: 8, title: "El Diluvio", dur: "00:43:13", desc: "Noé está muy preocupado por Cam y Tali, ya que todos han visto volar a las aves y están seguros de que el diluvio está cerca.", thumb: "https://static.wixstatic.com/media/859174_1b0e1a7eccee4d7aaf17fdc70a7995f6~mv2.jpg", url: "https://ok.ru/videoembed/14047824644608" },
  ...
  { id: 99, title: "Maldecidos", dur: "00:39:33", desc: "El harem de Abimelec pierde a sus hijos y no pueden embarazarse. Abraham intenta que", thumb: "https://static.wixstatic.com/media/859174_092facabef0a47dda929e428fc9ca870~mv2.jpg", url: "https://ok.ru/videoembed/14200601315840" },
        ...
        <div className="flex items-center gap-6">
          <div className="flex gap-4 mr-4">
            {[{ n: '', img: '367960b11c1c44ba89cd1582fd1b5776' }, { n: 'en', img: '35112d9ffe234d6f9dcef16cf8f7544e' }, { n: 'pt', img: '830f1c20656e4d44a819bedfc13a22cc' }].map((l) => (
              <Link key={l.n} href={l.n === '' ? '/serie/genesis' : `/${l.n}/serie/genesis`}><img src={`https://static.wixstatic.com/media/859174_${l.img}~mv2.png`} className="w-7 h-7 object-contain cursor-pointer hover:scale-110 transition-transform" /></Link>
            ))}
          </div>
          ...
          <div className="h-[12vh] min-h-[85px] px-12 flex items-center justify-between bg-gradient-to-b from-[#0a0b0d] to-[#050608] border-b border-white/5 relative shadow-2xl">
            <div className="flex items-center gap-8">
              <div className="flex flex-col border-l-4 border-[#FF8A00] pl-6 py-1 text-left">
                ...
                <h2 className="text-2xl font-black tracking-tighter uppercase">Capítulo {genesisEpisodes[currentIdx].id} <span className="text-white/10 mx-3">/</span> {genesisEpisodes[currentIdx].title}</h2>
              </div>
            </div>
