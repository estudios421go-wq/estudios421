...
// --- CONFIGURACIÓN DE EPISODIOS (ID: 28) ---
const reyesSucesionEpisodes = [
  "https://ok.ru/videoembed/9754241141431", "https://ok.ru/videoembed/9754241338039", "https://ok.ru/videoembed/9754251037367",
  "https://ok.ru/videoembed/9754251233975", "https://ok.ru/videoembed/9754251365047", "https://ok.ru/videoembed/9754251758263",
  "https://ok.ru/videoembed/9754252151479", "https://ok.ru/videoembed/9754252675767", "https://ok.ru/videoembed/9754272139959",
  "https://ok.ru/videoembed/9754272205495", "https://ok.ru/videoembed/9754272467639", "https://ok.ru/videoembed/9754272664247",
  "https://ok.ru/videoembed/9754274695863", "https://ok.ru/videoembed/9754275023543", "https://ok.ru/videoembed/9754275220151",
  "https://ok.ru/videoembed/9754275416759", "https://ok.ru/videoembed/9754275547831", "https://ok.ru/videoembed/9754275744439",
  "https://ok.ru/videoembed/9754275941047", "https://ok.ru/videoembed/9754276006583", "https://ok.ru/videoembed/9754292783799",
  "https://ok.ru/videoembed/9754292980407", "https://ok.ru/videoembed/9754293308087", "https://ok.ru/videoembed/9754293963447",
  "https://ok.ru/videoembed/9754294422199", "https://ok.ru/videoembed/9754294946487", "https://ok.ru/videoembed/9754295274167",
  "https://ok.ru/videoembed/9754296191671", "https://ok.ru/videoembed/9754296519351", "https://ok.ru/videoembed/9754296847031",
  "https://ok.ru/videoembed/9754297043639", "https://ok.ru/videoembed/9754297371319", "https://ok.ru/videoembed/9754299796151",
  "https://ok.ru/videoembed/9754300189367", "https://ok.ru/videoembed/9754302745271"
];

const ReyesSucesionMobile = () => {
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem('reyes_sucesion_mobile_last_ep');
  ...
  useEffect(() => {
    if (searchQuery.trim().length >= 2) {
      ...
      const themeMap: { [key: string]: string[] } = {
        ...
        reyes: ['reyes', 'david', 'saul', 'salomon', 'sucesion', 'decadencia'],
  ...
  const openEpisode = (idx: number) => {
    setSelectedVideo(reyesSucesionEpisodes[idx]);
    setCurrentIdx(idx);
    localStorage.setItem('reyes_sucesion_mobile_last_ep', idx.toString());
  };
  ...
  if (selectedVideo) {
    return (
      <div className="fixed inset-0 z-[2000] bg-[#050608] flex flex-col overflow-hidden text-left">
        <Head><title>Episodio {currentIdx + 1} — Reyes: La Sucesión</title></Head>
        <div className="px-6 h-[85px] flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent border-b border-white/5 z-10">
          <div className="flex flex-col border-l-4 border-[#F09800] pl-4 py-1">
            <span className="text-[9px] font-black text-[#F09800] uppercase tracking-[0.3em] mb-1">Reyes: La Sucesión</span>
        ...
        <div className="flex-grow flex flex-col relative bg-black items-center justify-center">
          ...
          <div className="absolute inset-x-0 bottom-8 flex justify-around items-center px-6">
            ...
            <button disabled={currentIdx === reyesSucesionEpisodes.length - 1} onClick={() => openEpisode(currentIdx + 1)} className="flex flex-col items-center gap-2 group disabled:opacity-5">
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans selection:bg-[#F09800] text-left">
      <Head><title>Reyes: La Sucesión — Estudios 421</title></Head>
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6">
            {[{l:'ESP', i:'367960b11c1c44ba89cd1582fd1b5776', p:'/serie/reyes-la-sucesion'}, {l:'ENG', i:'35112d9ffe234d6f9dcef16cf8f7544e', p:'/en/serie/reyes-la-sucesion'}, {l:'PT', i:'830f1c20656e4d44a819bedfc13a22cc', p:'/pt/serie/reyes-la-sucesion'}].map((lang) => (
      ...
      <div className="relative w-full pt-0 bg-black shadow-2xl">
        <div className="w-full aspect-[4/3] relative">
          <img src="https://static.wixstatic.com/media/859174_514c73817ffe4c6ea1ea0748bce2397e~mv2.jpg" className="w-full h-full object-contain" alt="Banner Reyes: La Sucesión" />
      ...
      {/* BOTÓN SIGUIENTE TEMPORADA MÓVIL */}
      <div className="px-5 mb-24">
          <Link href="/serie/reyes-la-decadencia">
      ...
      <footer className="bg-[#0a0a0a] text-gray-500 py-10 px-6 border-t border-white/5 text-left">
        ...
        <div className="space-y-4 mb-8 text-[10px]">
          ...
          <p className="text-gray-600 font-medium">Aviso Legal: El contenido audiovisual compartido en este sitio pertenece a sus respectivos propietarios. Estudios 421 es una plataforma sin fines de lucro para la difusión de contenido bíblico.</p>
        </div>
...
export default ReyesSucesionMobile;
