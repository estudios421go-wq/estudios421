...
// --- CONFIGURACIÓN DE EPISODIOS (ID: 8) ---
const reyDavidEpisodes = [
  "https://ok.ru/videoembed/7311487797856", "https://ok.ru/videoembed/7312151612000", "https://ok.ru/videoembed/7312151677536",
  "https://ok.ru/videoembed/7312151808608", "https://ok.ru/videoembed/7312151939680", "https://ok.ru/videoembed/7312152201824",
  "https://ok.ru/videoembed/7312304507488", "https://ok.ru/videoembed/7313842965088", "https://ok.ru/videoembed/7313843423840",
  "https://ok.ru/videoembed/7313843554912", "https://ok.ru/videoembed/7313843685984", "https://ok.ru/videoembed/7313843948128",
  "https://ok.ru/videoembed/7313844275808", "https://ok.ru/videoembed/7313844406880", "https://ok.ru/videoembed/7313850829408",
  "https://ok.ru/videoembed/7313965386336", "https://ok.ru/videoembed/7313965451872", "https://ok.ru/videoembed/7313965517408",
  "https://ok.ru/videoembed/7313965910624", "https://ok.ru/videoembed/7313966107232", "https://ok.ru/videoembed/7313966303840",
  "https://ok.ru/videoembed/7314053859936", "https://ok.ru/videoembed/7314054122080", "https://ok.ru/videoembed/7314054515296",
  "https://ok.ru/videoembed/7314054842976", "https://ok.ru/videoembed/7314062117472", "https://ok.ru/videoembed/7314062314080",
  "https://ok.ru/videoembed/7314062445152", "https://ok.ru/videoembed/7314068212320", "https://ok.ru/videoembed/7314073782880"
];
...
const ReyDavidPC = () => {
  ...
  useEffect(() => {
    ...
    const savedEp = localStorage.getItem('rey_david_last_ep');
    if (savedEp) {
      const idx = parseInt(savedEp);
      if (idx < reyDavidEpisodes.length) setCurrentIdx(idx);
    }
  ...
  useEffect(() => {
    if (searchQuery.trim().length >= 2) {
      ...
      const themeMap: { [key: string]: string[] } = {
        ...
        sanson: ['sanson', 'dalila'],
        david: ['david', 'rey david', 'saul', 'goliat', 'betsabe', 'israel'],
  ...
  const openEpisode = (idx: number) => {
    setCurrentIdx(idx);
    setSelectedVideo(reyDavidEpisodes[idx]);
    localStorage.setItem('rey_david_last_ep', idx.toString());
  };
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans select-none overflow-x-hidden text-left unselectable">
      ...
      <nav className={`fixed top-0 w-full z-[130] transition-all duration-500 px-8 py-4 flex items-center justify-between ${isScrolled || searchQuery.length > 0 ? 'bg-black shadow-lg' : 'bg-gradient-to-b from-black via-black/60 to-transparent'}`}>
        ...
        <div className="flex items-center gap-6">
          <div className="flex gap-4 mr-4">
            {[{ n: '', img: '367960b11c1c44ba89cd1582fd1b5776', p: '/serie/rey-david' }, 
              { n: 'en', img: '35112d9ffe234d6f9dcef16cf8f7544e', p: '/en/serie/rey-david' }, 
              { n: 'pt', img: '830f1c20656e4d44a819bedfc13a22cc', p: '/pt/serie/rey-david' }].map((l) => (
      ...
      <div className="relative w-full h-[88vh]">
        <img src="https://static.wixstatic.com/media/859174_798f621fd732402694f55a8c22f49511~mv2.jpg" className="w-full h-full object-cover" alt="Banner Rey David" />
        ...
        <div className="fixed inset-0 z-[1000] bg-[#050608] flex flex-col animate-fade-in">
          <div className="h-[12vh] min-h-[85px] px-12 flex items-center justify-between bg-gradient-to-b from-[#0a0b0d] to-[#050608] border-b border-white/5">
            <div className="flex flex-col border-l-4 border-[#FF8A00] pl-6 py-1 text-left">
              <span className="text-[10px] font-black text-[#FF8A00]/80 uppercase tracking-[0.5em] mb-1">Serie: Rey David</span>
          ...
          <div className="h-[13vh] min-h-[100px] px-16 bg-gradient-to-t from-[#0a0b0d] border-t border-white/5 flex items-center justify-between">
            ...
            <button disabled={currentIdx === reyDavidEpisodes.length - 1} onClick={() => openEpisode(currentIdx + 1)} className="group flex items-center gap-6 disabled:opacity-5 transition-all">
