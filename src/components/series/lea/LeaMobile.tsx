...
// Definición de episodios dentro del archivo para evitar el error de renderizado
const leaEpisodes = [
...
const LeaMobile = () => {
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans selection:bg-[#F09800]">
      ...
      {/* MENU LATERAL CON IDIOMAS FUNCIONALES */}
          ...
          <div className="flex flex-col gap-6 mt-4">
            ...
            <div className="flex gap-6">
              {[
                ...
                <button key={l.n} onClick={() => router.push(l.p)} className="flex flex-col items-center gap-2 active:scale-95 transition-transform">
      ...
      {/* BANNER CON DISEÑO ORIGINAL (PROPORCIÓN 4/3 Y MARGEN -MT-14) */}
        ...
        <div className="grid grid-cols-2 gap-4">
          {leaEpisodes.map((ep, index) => (
            <div key={ep.id} className="flex flex-col gap-2 active:opacity-70 transition-opacity" onClick={() => openEpisode(index)}>
              <div className={`relative aspect-video rounded-md overflow-hidden border ${currentIdx === index ? 'border-[#F09800]' : 'border-white/5'} shadow-lg pointer-events-none`}>
      ...
      {/* REPRODUCTOR CON FUNCIONALIDAD AVANZADA */}
      {selectedVideo && (
