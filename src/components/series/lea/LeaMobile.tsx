      ...
      {selectedVideo && (
        <div className="fixed inset-0 z-[2000] bg-black flex flex-col">
          <div className="p-4 flex justify-between items-center bg-black/80 backdrop-blur-md">
            <span className="text-[9px] font-black text-[#F09800] uppercase tracking-widest text-left">Lea — Cap. {leaEpisodes[currentIdx].id}</span>
          ...
          <div className="flex-grow flex flex-col relative bg-[#050608]">
            <iframe src={selectedVideo + "?autoplay=1"} className="w-full h-full border-none" allow="autoplay; fullscreen" allowFullScreen />
