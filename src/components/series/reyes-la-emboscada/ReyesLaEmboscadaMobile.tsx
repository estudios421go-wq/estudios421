...
const reyesEmboscadaEpisodes = [
  { id: 1, title: "DISFRUTA LA GUERRA", dur: "56:00", thumb: "https://static.wixstatic.com/media/859174_6e0d5c47c9f948d39d19b95f12527b56~mv2.jpg", url: "https://ok.ru/videoembed/16991211555328", available: true },
  { id: 2, title: "FUE INTENCIONAL", dur: "47:00", thumb: "https://static.wixstatic.com/media/859174_f82875db82e1495bb405e518a86b049a~mv2.jpg", url: "https://ok.ru/videoembed/16991212603904", available: true },
  { id: 3, title: "PREFIERO PENSAR", dur: "39:00", thumb: "https://static.wixstatic.com/media/859174_c011aff0d1434a5bb67309584260397f~mv2.jpg", url: "https://ok.ru/videoembed/16991213521408", available: true },
  ...
  { id: 8, title: "GRAN ERROR", dur: "49:00", thumb: "https://static.wixstatic.com/media/859174_24bb3c23d23549f99729a153533d49ed~mv2.jpg", url: "https://ok.ru/videoembed/18382750091776", available: true },
  { id: 9, title: "ACEPTA EL CUMPLIDO", dur: "51:00", thumb: "https://static.wixstatic.com/media/859174_4453e15055ce431a8acda8a46c8e0c57~mv2.jpg", url: "https://ok.ru/videoembed/18382750616064", available: true },
  { id: 10, title: "NI SIQUIERA LO DISIMULA", dur: "62:00", thumb: "https://static.wixstatic.com/media/859174_f18929c887e340bca2c9118f33ba911c~mv2.jpg", url: "https://ok.ru/videoembed/18382751009280", available: true },
  { id: 11, title: "NO PARECE", dur: "50:00", thumb: "https://static.wixstatic.com/media/859174_a78e9f2ea1bb445db3bd21fbd3fa49d6~mv2.jpg", url: "https://ok.ru/videoembed/18382751271424", available: true },
  { id: 12, title: "ENTONCES ES VERDAD...", dur: "44:00", thumb: "https://static.wixstatic.com/media/859174_f08f660cc00c4c208347066e399e219a~mv2.jpg", url: "https://ok.ru/videoembed/18382751795712", available: true },
  { id: 13, title: "SÉ BIEN CÓMO ES", dur: "52:00", thumb: "https://static.wixstatic.com/media/859174_507402a4d37f473480669fc3d291d750~mv2.jpg", url: "https://ok.ru/videoembed/18382752713216", available: true },
  { id: 14, title: "AYÚDAME", dur: "43:00", thumb: "https://static.wixstatic.com/media/859174_daf5a9ffa5574146a3b5d210cf1f7ed9~mv2.jpg", url: "https://ok.ru/videoembed/18397506636288", available: true },
  { id: 15, title: "NO DEBÍA SER ASÍ", dur: "37:00", thumb: "https://static.wixstatic.com/media/859174_df84be8d5cb542dfa94900889b8dcf8e~mv2.jpg", url: "https://ok.ru/videoembed/18397507750400", available: true },
  { id: 16, title: "¿QUIÉN ERES TÚ?", dur: "46:00", thumb: "https://static.wixstatic.com/media/859174_552ecd4c2ab34ddba76d68add523bdc2~mv2.jpg", url: "https://ok.ru/videoembed/16991211553328", available: true },
  { id: 17, title: "BÉSAME", dur: "43:00", thumb: "https://static.wixstatic.com/media/859174_2bfa035dd54d45e3b00d780e07fac2ed~mv2.jpg", url: "https://ok.ru/videoembed/16991211555428", available: true },
  { id: 18, title: "TU LUZ", dur: "51:00", thumb: "https://static.wixstatic.com/media/859174_4b3918cb0b344a1bad44d18eaddb828b~mv2.jpg", url: "https://ok.ru/videoembed/16991211553328", available: true },
  { id: 19, title: "SOLO TÚ", dur: "55:00", thumb: "https://static.wixstatic.com/media/859174_6c35d20aec0b41378ded779b53bd972e~mv2.jpg", url: "https://ok.ru/videoembed/16991211556328", available: true },
  { id: 20, title: "NO ES UNA MALA IDEA", dur: "43:00", thumb: "https://static.wixstatic.com/media/859174_b9f4d47b4d5b4a9a9dda22f56424407b~mv2.jpg", url: "https://ok.ru/videoembed/16991211557328", available: true },
  { id: 21, title: "¡ME TRAICIONASTE!", dur: "46:00", thumb: "https://static.wixstatic.com/media/859174_66e3e7970c254620aeca8e0a564961d5~mv2.jpg", url: "https://ok.ru/videoembed/16991211558328", available: true },
  { id: 22, title: "YO TE QUERÍA", dur: "59:00", thumb: "https://static.wixstatic.com/media/859174_b1f9984d20e74fe6b636e2f1faf42870~mv2.jpg", url: "https://ok.ru/videoembed/16991211559328", available: true },
  { id: 23, title: "ES SOLO UN NIÑO", dur: "57:00", thumb: "https://static.wixstatic.com/media/859174_f19fa43997234e299b97e5c55597f139~mv2.jpg", url: "https://ok.ru/videoembed/16991211551028", available: true },
];

const ReyesEmboscadaMobile = () => {
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem('reyes_emboscada_mobile_last_ep');
    if (saved) {
        const idx = parseInt(saved);
        if (reyesEmboscadaEpisodes[idx]?.available) setCurrentIdx(idx);
    }
  ...
  useEffect(() => {
    if (searchQuery.trim().length >= 2) {
      ...
      const themeMap: { [key: string]: string[] } = {
        ...
        reyes: ['reyes', 'david', 'saul', 'salomon', 'emboscada', 'omri', 'asa'],
  ...
  const openEpisode = (idx: number) => {
    if (!reyesEmboscadaEpisodes[idx].available) return;
    setSelectedVideo(reyesEmboscadaEpisodes[idx].url || null);
    setCurrentIdx(idx);
    localStorage.setItem('reyes_emboscada_mobile_last_ep', idx.toString());
  };
  ...
  if (selectedVideo) {
    return (
      <div className="fixed inset-0 z-[2000] bg-[#050608] flex flex-col overflow-hidden text-left unselectable">
        <Head><title>Reproduciendo: {reyesEmboscadaEpisodes[currentIdx].title}</title></Head>
        <div className="px-6 h-[85px] flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent border-b border-white/5 z-10">
          <div className="flex flex-col border-l-4 border-[#F09800] pl-4 py-1 text-left">
            <span className="text-[9px] font-black text-[#F09800] uppercase tracking-[0.3em] mb-1">Reyes: La Emboscada</span>
            <h2 className="text-sm font-black tracking-tight uppercase truncate max-w-[200px]">Ep. {reyesEmboscadaEpisodes[currentIdx].id} | {reyesEmboscadaEpisodes[currentIdx].title}</h2>
          </div>
        ...
        <div className="flex-grow flex flex-col relative bg-black items-center justify-center">
          ...
          <div className="absolute inset-x-0 bottom-8 flex justify-around items-center px-6">
            ...
            <button disabled={currentIdx === reyesEmboscadaEpisodes.length - 1} onClick={() => openEpisode(currentIdx + 1)} className="flex flex-col items-center gap-2 group disabled:opacity-5">
    ...
    <div className="bg-black min-h-screen text-white font-sans selection:bg-[#F09800] text-left unselectable">
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6 text-left">
            {[{l:'ESP', i:'367960b11c1c44ba89cd1582fd1b5776', p:'/serie/reyes-la-emboscada'}, {l:'ENG', i:'35112d9ffe234d6f9dcef16cf8f7544e', p:'/en/serie/kings-the-ambush'}, {l:'PT', i:'830f1c20656e4d44a819bedfc13a22cc', p:'/pt/serie/reis-a-emboscada'}].map((lang) => (
      ...
      <div className="relative w-full pt-0 bg-black shadow-2xl">
        <div className="w-full aspect-[4/3] relative">
          <img src="https://static.wixstatic.com/media/859174_8cf0f9b25c744e5aba0410d6687b1821~mv2.jpg" className="w-full h-full object-contain" alt="Banner" />
        ...
        <div className="px-4 -mt-14 flex flex-col gap-3 relative z-20">
          <button onClick={() => openEpisode(currentIdx)} className="w-full bg-white text-black font-black py-4 rounded-md text-sm active:scale-95 transition-transform uppercase tracking-[0.2em] shadow-2xl">
            {currentIdx === 0 ? "▶ Ver Ahora" : `▶ Continuar Ep. ${reyesEmboscadaEpisodes[currentIdx].id}`}
          </button>
...
export default ReyesEmboscadaMobile;
