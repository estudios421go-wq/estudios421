...
const JesusDeNazaretMobile = () => (
  <div className="bg-black min-h-screen text-white font-sans flex flex-col text-center">
    <Head><title>Jesús de Nazaret — Móvil</title></Head>
    <div className="flex-grow flex flex-col items-center justify-center px-8 relative">
      <div className="w-16 h-1 bg-[#FF8A00] mb-6" />
      <h1 className="text-3xl font-black uppercase tracking-widest mb-4 leading-tight">Jesús de Nazaret</h1>
      <p className="text-[#FF8A00] text-[10px] font-bold tracking-widest uppercase mb-6 animate-pulse">Próximamente</p>
      <p className="text-gray-500 text-xs leading-relaxed mb-10 text-center">La historia que cambió el mundo, muy pronto en tus dispositivos móviles.</p>
...
export default JesusDeNazaretMobile;
