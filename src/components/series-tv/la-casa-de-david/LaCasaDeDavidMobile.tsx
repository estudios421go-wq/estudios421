...
const davidEpisodes = [
  // TEMPORADA 1
  { id: 1, season: 1, title: "PASTOR Y REY", thumb: "https://static.wixstatic.com/media/859174_8b4989cffc044ac69fc7766f9ee2268c~mv2.webp", url: "https://drive.google.com/file/d/1yv8h923_RnwiaFEnLMLJWJ7ZKXxIYXTO/preview" },
  { id: 2, season: 1, title: "UN ABISMO LLAMA A OTRO ABISMO", thumb: "https://static.wixstatic.com/media/859174_007f7c4183c74677b17e86e0f7cc4218~mv2.webp", url: "https://drive.google.com/file/d/1oVCAvsPuSMKLJiSGr-1OCBofJO68WPg3/preview" },
  { id: 3, season: 1, title: "LA UNCIÓN", thumb: "https://static.wixstatic.com/media/859174_570af26a7bc449c1bf7c60c750866748~mv2.webp", url: "https://drive.google.com/file/d/1SsO6jnrjohGu1580dT3zAckyn7HWYus3/preview" },
  { id: 4, season: 1, title: "EL CÁNTICO DE MOISÉS", thumb: "https://static.wixstatic.com/media/859174_b385a043c11c45d8a5870377676c51ff~mv2.webp", url: "https://drive.google.com/file/d/1IHZXZPCxKxfzZLA0mZR40zbKXuPsrxzm/preview" },
  { id: 5, season: 1, title: "EL LOBO Y EL LEÓN", thumb: "https://static.wixstatic.com/media/859174_99024d73744540678c8edf4ecfb359b2~mv2.webp", url: "https://drive.google.com/file/d/1ho4K0yAjtqLljLggorpxSEh93cOE48_X/preview" },
  { id: 6, season: 1, title: "EL DESPERTAR DE LOS GIGANTES", thumb: "https://static.wixstatic.com/media/859174_0b0512122127407e9b32ace5ba286a08~mv2.webp", url: "https://drive.google.com/file/d/1Ev-3KU7jB3CcXKuufBs5ishkrSr99jWv/preview" },
  { id: 7, season: 1, title: "DAVID Y GOLIAT — PARTE 1", thumb: "https://static.wixstatic.com/media/859174_27eb74f4ef644c88979549413b337c79~mv2.webp", url: "https://drive.google.com/file/d/1CkJvv2ZhZ_Dk-8qpMiiJCwupqhcgROTW/preview" },
  { id: 8, season: 1, title: "DAVID Y GOLIAT — PARTE 2", thumb: "https://static.wixstatic.com/media/859174_4b40f2423c914e4389b206d2c6100d2a~mv2.webp", url: "https://drive.google.com/file/d/1LlbKb8PYzVmMeKI9HHoW7h6o9E7MUvKi/preview" },
  ...
  { id: 11, season: 2, title: "EL CAMINO INTERMEDIO", thumb: "https://static.wixstatic.com/media/859174_49a90b4238624b89994d800a64cfbe14~mv2.jpg", url: "https://drive.google.com/file/d/1YIyeDqklHCQnWJCxfvAjF88u40BsZVqr/preview", isNew: true },
  ...
  { id: 16, season: 2, title: "LA VERDAD REVELADA", thumb: "https://static.wixstatic.com/media/859174_1039ec57f90649689f2996b78c989da6~mv2.webp", url: "https://drive.google.com/file/d/1cOFAjxz8_ltpJWuTgMDhZMZdAntg1zU/preview", isNew: true },
];

const HouseOfDavidMobile = () => {
  const router = useRouter();
  const [selectedVideo, setSelectedVideo] = useState<string | null>(null);
  const [currentIdx, setCurrentIdx] = useState<number>(8); // Inicia en T2 E1
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem('david_mobile_last_ep');
  ...
  const openEpisode = (idx: number) => {
    ...
    setCurrentIdx(idx);
    localStorage.setItem('david_mobile_last_ep', idx.toString());
  };
  ...
  if (selectedVideo) {
    return (
      <div className="fixed inset-0 z-[2000] bg-[#050608] flex flex-col overflow-hidden text-left">
        <Head><title>REPRODUCIENDO: {davidEpisodes[currentIdx].title}</title></Head>
        <div className="px-6 h-[85px] flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent border-b border-white/5 z-10">
          <div className="flex flex-col border-l-4 border-[#F09800] pl-4 py-1">
            <span className="text-[9px] font-black text-[#F09800] uppercase tracking-[0.3em] mb-1">SERIE: LA CASA DE DAVID</span>
            <h2 className="text-sm font-black tracking-tight uppercase truncate max-w-[200px]">
              T.{davidEpisodes[currentIdx].season} | {davidEpisodes[currentIdx].title}
            </h2>
          </div>
        ...
        <div className="flex-grow flex flex-col relative bg-black items-center justify-center">
          ...
          <div className="absolute inset-x-0 bottom-8 flex justify-around items-center px-6">
            ...
            <button disabled={currentIdx === davidEpisodes.length - 1} onClick={() => openEpisode(currentIdx + 1)} className="flex flex-col items-center gap-2 group disabled:opacity-5">
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6">
            {[{l:'ESP', i:'367960b11c1c44ba89cd1582fd1b5776', p:'/serie/la-casa-de-david'}, {l:'ENG', i:'35112d9ffe234d6f9dcef16cf8f7544e', p:'/en/serie/house-of-david'}, {l:'PT', i:'830f1c20656e4d44a819bedfc13a22cc', p:'/pt/serie/casa-de-davi'}].map((lang) => (
          ...
          {davidEpisodes.map((ep, index) => (
            <div key={index} className="flex flex-col gap-2.5 active:scale-95 transition-all" onClick={() => openEpisode(index)}>
              <div className={`relative aspect-video rounded-lg overflow-hidden border-2 ${currentIdx === index ? 'border-[#F09800] shadow-[0_0_15px_rgba(240,152,0,0.2)]' : 'border-white/5'}`}>
                ...
                {ep.isNew && (
                  <div className="absolute top-1.5 right-1.5 bg-[#F09800] px-1.5 py-0.5 rounded-[3px] text-[7px] font-black text-black uppercase tracking-tighter">NUEVO</div>
                )}
...
export default HouseOfDavidMobile;
