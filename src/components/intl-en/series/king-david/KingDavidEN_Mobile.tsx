...
const KingDavidEpisodes = [
  "https://ok.ru/videoembed/8188492450320", "https://ok.ru/videoembed/8188492778000", "https://ok.ru/videoembed/8188493892112",
  "https://ok.ru/videoembed/8197553785360", "https://ok.ru/videoembed/8201461434896", "https://ok.ru/videoembed/8204778736144",
  "https://ok.ru/videoembed/8207809448464", "https://ok.ru/videoembed/8210755095056", "https://ok.ru/videoembed/8219460700688",
  "https://ok.ru/videoembed/8222357129744", "https://ok.ru/videoembed/8224974047760", "https://ok.ru/videoembed/8226880948752",
  "https://ok.ru/videoembed/8226881145360", "https://ok.ru/videoembed/8228082354704", "https://ok.ru/videoembed/8241109928464",
  "https://ok.ru/videoembed/8247339518480", "https://ok.ru/videoembed/8254357703184", "https://ok.ru/videoembed/8258273675792",
  "https://ok.ru/videoembed/8264397228560", "https://ok.ru/videoembed/8267880794640", "https://ok.ru/videoembed/8272485878288",
  "https://ok.ru/videoembed/8284120287760", "https://ok.ru/videoembed/8288664685072", "https://ok.ru/videoembed/8288820070928",
  "https://ok.ru/videoembed/8299087596048", "https://ok.ru/videoembed/8312147610128", "https://ok.ru/videoembed/8312795236880",
  "https://ok.ru/videoembed/8314059885072", "https://ok.ru/videoembed/8318199466512", "https://ok.ru/videoembed/8321145440784"
];

const KingDavidEN_Mobile = () => {
  ...
  useEffect(() => {
    ...
    const savedIdx = localStorage.getItem('king_david_mobile_last_idx_en');
  ...
  const openEpisode = (idx: number) => {
    setSelectedVideo(KingDavidEpisodes[idx]);
    setCurrentIdx(idx);
    localStorage.setItem('king_david_mobile_last_idx_en', idx.toString());
  };
  ...
  if (selectedVideo) {
    return (
      <div className="fixed inset-0 z-[2000] bg-[#050608] flex flex-col overflow-hidden text-left unselectable">
        <Head><title>Watching: Episode {currentIdx + 1} — King David</title></Head>
        <div className="px-6 h-[85px] flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent border-b border-white/5 z-10">
          <div className="flex flex-col border-l-4 border-[#FF8A00] pl-4 py-1 text-left">
            <span className="text-[9px] font-black text-[#FF8A00] uppercase tracking-[0.3em] mb-1">King David</span>
        ...
        <div className="flex-grow flex flex-col relative bg-black items-center justify-center">
          ...
          <div className="absolute inset-x-0 bottom-8 flex justify-around items-center px-6">
            ...
            <button disabled={currentIdx === KingDavidEpisodes.length - 1} onClick={() => openEpisode(currentIdx + 1)} className="flex flex-col items-center gap-2 group disabled:opacity-5">
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans selection:bg-[#FF8A00] text-left unselectable">
      <Head><title>King David — Estudios 421</title></Head>
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6">
            {[{l:'ESP', i:'367960b11c1c44ba89cd1582fd1b5776', p:'/serie/rey-david'}, {l:'ENG', i:'35112d9ffe234d6f9dcef16cf8f7544e', p:'/en/series/king-david'}, {l:'PT', i:'830f1c20656e4d44a819bedfc13a22cc', p:'/pt/series/rei-davi'}].map((lang) => (
      ...
      <div className="relative w-full pt-0 bg-black shadow-2xl">
        <div className="w-full aspect-[4/3] relative">
          <img src="https://static.wixstatic.com/media/859174_e0e83701d7154bbfa97a2253496356c8~mv2.jpg" className="w-full h-full object-contain" alt="King David Banner" />
...
export default KingDavidEN_Mobile;
