...
const MiraclesOfJesusEpisodes = [
  "https://ok.ru/videoembed/10493220751888", "https://ok.ru/videoembed/10493220882960", "https://ok.ru/videoembed/10499363768844",
...
const MiraclesOfJesusEN_PC = () => {
  ...
  const SERIES_ID = 15; // Replaced ID
  ...
  useEffect(() => {
    ...
    const savedIdx = localStorage.getItem('miracles_jesus_last_idx_en');
    if (savedIdx) {
  ...
  const openEpisode = (idx: number) => {
    const url = MiraclesOfJesusEpisodes[idx];
    setCurrentIdx(idx);
    setSelectedVideo(url);
    localStorage.setItem('miracles_jesus_last_idx_en', idx.toString());
  };
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans select-none overflow-x-hidden text-left unselectable">
        ...
        <div className="flex items-center gap-6">
          <div className="flex gap-4 mr-4">
            {[{ n: '', img: '367960b11c1c44ba89cd1582fd1b5776', p: '/serie/los-milagros-de-jesus' }, 
              { n: 'en', img: '35112d9ffe234d6f9dcef16cf8f7544e', p: '/en/series/miracles-of-jesus' }, 
              { n: 'pt', img: '830f1c20656e4d44a819bedfc13a22cc', p: '/pt/series/milagres-de-jesus' }].map((l) => (
      ...
      <div className="relative w-full h-[88vh]">
        <img src="https://static.wixstatic.com/media/859174_e28be83db93148cfb4c79e9758eb8331~mv2.png" className="w-full h-full object-cover" alt="Banner Miracles of Jesus" />
      ...
      {selectedVideo && (
        <div className="fixed inset-0 z-[1000] bg-[#050608] flex flex-col animate-fade-in overflow-hidden">
          <div className="h-[12vh] min-h-[85px] px-12 flex items-center justify-between bg-gradient-to-b from-[#0a0b0d] to-[#050608] border-b border-white/5 relative shadow-2xl">
            <div className="flex items-center gap-8">
              <div className="flex flex-col border-l-4 border-[#FF8A00] pl-6 py-1 text-left">
                <span className="text-[10px] font-black text-[#FF8A00]/80 uppercase tracking-[0.5em] mb-1">Series: The Miracles of Jesus</span>
          ...
          <div className="h-[13vh] min-h-[100px] px-16 bg-gradient-to-t from-[#0a0b0d] to-[#050608] border-t border-white/5 flex items-center justify-between shadow-2xl">
            ...
            <button 
              disabled={currentIdx === MiraclesOfJesusEpisodes.length - 1} 
...
export default MiraclesOfJesusEN_PC;
