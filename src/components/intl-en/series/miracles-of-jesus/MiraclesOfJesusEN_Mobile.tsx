...
const MiraclesOfJesusEpisodes = [
  "https://ok.ru/videoembed/10493220751888", "https://ok.ru/videoembed/10493220882960", "https://ok.ru/videoembed/10499363768848",
  "https://ok.ru/videoembed/10499363965456", "https://ok.ru/videoembed/10499364162064", "https://ok.ru/videoembed/11058589927952",
  "https://ok.ru/videoembed/11058590190096", "https://ok.ru/videoembed/11058643995152", "https://ok.ru/videoembed/11058598578704",
  "https://ok.ru/videoembed/11058616732176", "https://ok.ru/videoembed/11058617125392", "https://ok.ru/videoembed/11058617453072",
  "https://ok.ru/videoembed/11058617649680", "https://ok.ru/videoembed/11058617715216", "https://ok.ru/videoembed/11058618370576",
  "https://ok.ru/videoembed/11058772838928", "https://ok.ru/videoembed/11058773166608", "https://ok.ru/videoembed/11058773363216",
  "https://ok.ru/videoembed/11062222719504", "https://ok.ru/videoembed/11062249392656", "https://ok.ru/videoembed/11062259288592",
  "https://ok.ru/videoembed/11062259550736", "https://ok.ru/videoembed/11062272920080", "https://ok.ru/videoembed/11062272985616",
  "https://ok.ru/videoembed/11062273313296", "https://ok.ru/videoembed/11062278752784", "https://ok.ru/videoembed/11062286879248",
  "https://ok.ru/videoembed/11062286944784", "https://ok.ru/videoembed/11062451178000", "https://ok.ru/videoembed/11062451243536",
  "https://ok.ru/videoembed/11062455241232", "https://ok.ru/videoembed/11062455437840", "https://ok.ru/videoembed/11062458780176",
  "https://ok.ru/videoembed/11062458976784", "https://ok.ru/videoembed/11062459042320"
];

const MiraclesOfJesusEN_Mobile = () => {
  ...
  useEffect(() => {
    ...
    const savedIdx = localStorage.getItem('miracles_jesus_mobile_last_idx_en');
  ...
  const openEpisode = (idx: number) => {
    setSelectedVideo(MiraclesOfJesusEpisodes[idx]);
    setCurrentIdx(idx);
    localStorage.setItem('miracles_jesus_mobile_last_idx_en', idx.toString());
  };
  ...
  if (selectedVideo) {
    return (
      <div className="fixed inset-0 z-[2000] bg-[#050608] flex flex-col overflow-hidden text-left unselectable">
        <Head><title>Watching: Episode {currentIdx + 1} — Miracles of Jesus</title></Head>
        <div className="px-6 h-[85px] flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent border-b border-white/5 z-10">
          <div className="flex flex-col border-l-4 border-[#FF8A00] pl-4 py-1 text-left">
            <span className="text-[9px] font-black text-[#FF8A00] uppercase tracking-[0.3em] mb-1">The Miracles of Jesus</span>
        ...
        <div className="flex-grow flex flex-col relative bg-black items-center justify-center">
          ...
          <div className="absolute inset-x-0 bottom-8 flex justify-around items-center px-6">
            ...
            <button disabled={currentIdx === MiraclesOfJesusEpisodes.length - 1} onClick={() => openEpisode(currentIdx + 1)} className="flex flex-col items-center gap-2 group disabled:opacity-5">
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans selection:bg-[#FF8A00] text-left unselectable">
      <Head><title>The Miracles of Jesus — Estudios 421</title></Head>
      ...
      <div className={`fixed inset-0 bg-black/98 z-[100] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full pt-24 px-8 gap-8 text-left">
          ...
          <div className="flex gap-6">
            {[{l:'ESP', i:'367960b11c1c44ba89cd1582fd1b5776', p:'/serie/los-milagros-de-jesus'}, {l:'ENG', i:'35112d9ffe234d6f9dcef16cf8f7544e', p:'/en/series/miracles-of-jesus'}, {l:'PT', i:'830f1c20656e4d44a819bedfc13a22cc', p:'/pt/series/milagres-de-jesus'}].map((lang) => (
      ...
      <div className="relative w-full pt-0 bg-black shadow-2xl">
        <div className="w-full aspect-[4/3] relative">
          <img src="https://static.wixstatic.com/media/859174_e28be83db93148cfb4c79e9758eb8331~mv2.png" className="w-full h-full object-contain" alt="Miracles of Jesus Banner" />
      ...
      <div className="px-5 mt-12 mb-20 text-left">
        ...
        <div className="grid grid-cols-5 gap-3">
          {MiraclesOfJesusEpisodes.map((_, i) => (
...
export default MiraclesOfJesusEN_Mobile;
