...
const leahEpisodes = [
  { 
    id: 1, 
    title: "Special Clip: Leah's Journey", 
    dur: "00:05:30", 
    desc: "Experience the story of Laban's eldest daughter, who faces family rejection and her husband Jacob's indifference. A story of faith, resilience, and how God honors her as the mother of six tribes of Israel.", 
    thumb: "https://static.wixstatic.com/media/859174_4cebd7903ec14465a19f48bc9e7cbb47~mv2.jpg", 
    url: "https://ok.ru/videoembed/15167130765824" 
  }
];
...
const LeahEN_PC = () => {
  ...
  const SERIES_ID = 2; // ID de Leah según me indicaste
  ...
  const openEpisode = (idx: number) => {
    setCurrentIdx(idx);
    setSelectedVideo(leahEpisodes[idx].url);
  };
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans select-none overflow-x-hidden text-left unselectable">
      <Head><title>Leah — Estudios 421</title></Head>
        ...
        <div className="flex items-center gap-6">
          <div className="flex gap-4 mr-4">
            {[{ n: '', img: '367960b11c1c44ba89cd1582fd1b5776' }, { n: 'en', img: '35112d9ffe234d6f9dcef16cf8f7544e' }, { n: 'pt', img: '830f1c20656e4d44a819bedfc13a22cc' }].map((l) => (
              <Link key={l.n} href={l.n === '' ? '/serie/lea' : `/${l.n}/series/leah`}><img src={`https://static.wixstatic.com/media/859174_${l.img}~mv2.png`} className="w-7 h-7 object-contain cursor-pointer hover:scale-110 transition-transform" /></Link>
            ))}
          </div>
      ...
      <div className="relative w-full h-[88vh]">
        <img src="https://static.wixstatic.com/media/859174_4cebd7903ec14465a19f48bc9e7cbb47~mv2.jpg" className="w-full h-full object-cover" alt="Banner Leah" />
        ...
        <div className="absolute bottom-[-30px] left-16 flex gap-6 z-20 items-center">
          <button onClick={() => openEpisode(0)} className="bg-white text-black font-black py-4 px-12 rounded-sm text-lg hover:bg-[#FF8A00] hover:text-white transition-all duration-300 transform hover:scale-105 shadow-2xl uppercase tracking-wider">
            ▶ Watch Clip
          </button>
      ...
      <div className="px-16 mb-20 relative z-10 text-left">
        <header className="flex items-center gap-4 mb-10 border-b border-white/10 pb-4">
          ...
          <h2 className="text-2xl font-bold tracking-tight uppercase">Special Content</h2>
        </header>

        <div className="grid grid-cols-4 gap-8 mb-16">
          {leahEpisodes.map((ep, index) => (
              ...
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute bottom-2 left-2 flex items-center">
                  <div className="bg-black/40 backdrop-blur-md border border-white/10 px-3 py-1 rounded-md shadow-lg">
                    <span className="text-[11px] font-black uppercase text-white">Clip <span className="text-[#FF8A00]">#1</span></span>
                  </div>
                </div>
              </div>
        ...
        {/* MENSAJE ESPECIAL DE ESPERANZA Y DONACIÓN */}
        <div className="max-w-4xl bg-white/[0.03] border border-white/10 p-8 rounded-2xl shadow-inner mb-24">
          <p className="text-gray-300 text-lg italic leading-relaxed mb-6">
            "Just as God remembered Leah and transformed her pain into a blessing for generations, 
            there is always a light of hope for those who wait in faith. No matter the desert 
            you are crossing, your story is not over."
          </p>
          ...
          <div className="h-[12vh] min-h-[85px] px-12 flex items-center justify-between bg-gradient-to-b from-[#0a0b0d] to-[#050608] border-b border-white/5 relative shadow-2xl">
            <div className="flex items-center gap-8">
              <div className="flex flex-col border-l-4 border-[#FF8A00] pl-6 py-1 text-left">
                <span className="text-[10px] font-black text-[#FF8A00]/80 uppercase tracking-[0.5em] mb-1">Series: Leah</span>
                <h2 className="text-2xl font-black tracking-tighter uppercase">{leahEpisodes[0].title}</h2>
              </div>
            </div>
