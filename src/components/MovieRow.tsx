...
const MovieRow = ({ title, movies }: MovieRowProps) => {
  const settings = {
    ...
    responsive: [
      ...
      { breakpoint: 480, settings: { slidesToShow: 3.1, slidesToScroll: 1 } },
    ],
  };
    ...
    <div className="mb-6 md:mb-10 px-2 md:px-16 relative group/row overflow-hidden">
      ...
      <div className="relative">
        <Slider {...settings} className="movie-slider">
          {movies.map((movie) => (
            <div key={movie.id} className="outline-none py-2 md:py-6 px-1"> 
      ...
      <style jsx global>{`
        @media (max-width: 480px) {
          /* Ajuste de tamaño ideal: 31vw permite ~3.2 pósters por fila */
          .movie-slider .slick-slide {
            width: 31vw !important; 
          }
          /* BLOQUEO DE FILAS: Obliga a mantenerse en una sola línea */
